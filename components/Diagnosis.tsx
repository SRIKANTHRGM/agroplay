    ...
    <div className="max-w-7xl mx-auto space-y-12 page-transition pb-24 relative px-4">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 print:hidden relative z-10">
        <div className="space-y-4">
          ...
          <h2 className="text-6xl font-black text-white outfit tracking-tighter uppercase italic text-shadow-glow">Specimen Analysis</h2>
              ...
              {isCameraActive ? (
                ...
                <div className="flex flex-col items-center text-center space-y-10 p-12 relative z-10">
                  ...
                  <div className="space-y-3">
                    <p className="text-4xl font-black text-white outfit tracking-tighter uppercase italic">Engage Neural Scanner</p>
